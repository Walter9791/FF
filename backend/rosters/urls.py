...
from .views import TeamRosterAPIView, TeamScheduleAPIView, RosterEntryUpdateAPIView, FreeAgentsAPIView, FreeAgencyTransaction
...
urlpatterns = [
    ...
    path('leagues/<int:league_id>/teams/<int:team_id>/add-drop/', FreeAgencyTransaction.as_view(), name='free-agent'),
]
