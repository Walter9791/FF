        ...
        const fetchMatchupAndRoster = async () => {
            try {
                ...
                if (matchupResponse.data) {
                    ...
                    setRoster(myTeam.active_roster_spots);  
                    setBench(myTeam.bench_spots); 
                    // console.log('Set Roster:', myTeam.active_roster_spots);
                    setOpponentRoster(opponentTeam.active_roster_spots);  
                    setOpponentBench(opponentTeam.bench_spots); 
